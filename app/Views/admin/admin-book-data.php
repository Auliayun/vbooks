...
<div class="table-responsive">
  ...
  <div class="container mb-1" data-wow-delay="0.1s">
    <div class="row" data-wow-delay="0.1s">
            <div class="col-md-1">
                <a href="/book_data" class="btn btn-general btn-primary mb-2" >General</a>
            </div>
            <div class="col-md-1">
                <a href="/book_data_final" class="btn btn-final btn-primary mb-2" style="margin-left: 40px; color:#487baa; background-color: #fff; border: 1px solid #487baa;">Final Task</a>
            </div>
        </div>
  </div>
